...
$page_title = 'Laporan Rekapitulasi Kondisi Fisik Bahan Pustaka';
$reportView = false;
$num_recs_show = 20;
if (isset($_GET['reportView'])) {
    $reportView = true;
...
?>
    <!-- filter -->
    <div class="per_title">
        <h2><?php echo __('Laporan Rekapitulasi Kondisi Fisik Bahan Pustaka'); ?></h2>
    </div>
    <div class="infoBox">
...
<?php
    ...
    $xlsquery = "SELECT DATE(i.last_update) AS '" . __('TANGGAL SURVEY') . "',
            b.title AS '" . __('JUDUL') . "',
